...
export const products: Product[] = [
  ...
  // 7. Rapid Agro Care: Commercial Fish Cultivation & Modern Aquaculture
  {
    id: "prod-agro-02",
    slug: "rapid-agro-care-fish-cultivation",
    name: "Commercial Fish Cultivation & Modern Delta Aquaculture",
    bengaliName: "র‍্যাপিড এগ্রো কেয়ার আধুনিক মৎস্য চাষ ও প্রকল্প",
    sisterConcern: "Rapid Agro Care",
    category: "agro-care",
    categoryLabel: "Rapid Agro Care",
    shortDescription:
      "Scientific pond fish cultivation, carp polyculture, and nursery management across Manikganj.",
    description:
      "Developed and managed under Rapid Agro Care's aquaculture division in Manikganj. We implement scientific pond preparation, optimal stocking density, aquatic water quality management, and disease prevention for Rohu, Katla, Mrigal, and Tilapia. Dedicated to elevating freshwater fisheries productivity and rural food security.",
    images: {
      main: "/images/rapid_agro_fish_cultivation.jpg",
      detail: "/images/rapid_agro_fish_cultivation.jpg",
      lifestyle: "/images/rapid_agro_fish_cultivation.jpg",
    },
    materials: [
      "Scientific Pond Ecosystem",
      "Certified Fingerlings & Nursery Stock",
      "Oxygen Aeration System",
    ],
    dimensions: "Commercial Pond Acreage (5 to 50 Bigha Waterbodies)",
    colors: ["Freshwater Delta Habitat"],
    availability: "Direct Distribution",
    featured: false,
    newArrival: false,
    handmade: false,
    craftInfo: {
      origin: "Rapid Agro Care Aquaculture Hub, Sakrail, Gorpara, Manikgonj",
      technique: "Scientific freshwater carp polyculture & aeration management",
      artisanRole: "Aquaculture Specialists & Field Officers",
      craftingDuration: "Continuous 6-12 month cultivation cycles",
    },
    careInstructions: [
      "Maintain dissolved oxygen levels above 5.0 mg/L",
      "Monitor pond water pH between 7.5 and 8.5",
      "Feed with certified floating aqua pellets at regular scheduled intervals",
    ],
  },
