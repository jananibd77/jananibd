...
export const siteConfig = {
  ...
  sisterConcerns: [
    ...
    },
    {
      ...
      subtitle: "Importer & Distributor Fish Feed & Veterinary Medicine",
      bengaliSubtitle: "আমদানিকারক ও পরিবেশক: উন্নত মানের মাছের খাদ্য ও ভেটেরিনারি ওষুধ",
      description:
        "Driving agricultural vitality and food security across rural Bangladesh. Importer and primary distributor of scientifically balanced aquaculture fish feed and comprehensive veterinary healthcare medicines.",
      products: [
        "High-Protein Aqua Culture Fish Feed",
        "Veterinary & Livestock Healthcare Medicines",
        "Nutritional Supplements for Dairy & Poultry",
        "Aquaculture Quality Enhancers",
      ],
